...
Bolter: 3d8 piercing, 24 inches
Plasma Pistol: 3d6 lightning, 12 inches
(Infantry Squad)
Vox-caster: planetary communication
Mortar: Medium object
    Armor Class: 19
    Weight: {{{weight}}}
    Hit Points: 50
    Damage immunities: poison, psychic
    Cost: 5,000 gp
    Similar to its brother, the cannon, the mortar uses gunpowder to propel heavy balls of cast iron through the air at destructive speeds; however, it instead launch the ball in an arc more then a straight line to fall at the target from above. In a campaign without gunpowder, a cannon might be an arcane device built by clever gnomes or wizardly engineers. The mortar can hit targets behind cover.

    A mortar is usually supported in a wooden frame with wheels. Before it can be fired, the mortar must be loaded and aimed. It takes one action to load the weapon, one action to aim it, and one action to fire it.

    Mortar Ball: Ranged Weapon Attack: +6 to hit, range 80 inches, one target. Hit: 27 (5d10) bludgeoning damage.
Autocannon: Large object
    Armor Class: 19
    Weight: {{{weight}}}
    Hit Points: 150
    Damage immunities: poison, psychic
